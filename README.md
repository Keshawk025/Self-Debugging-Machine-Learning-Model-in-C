...
A self-debugging machine learning implementation in C that trains a linear regression model using gradient descent while automatically monitoring training behavior to detect and warn about common issues like divergence, unstable learning, and poor convergence.
